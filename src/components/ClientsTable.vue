...
const modalDeletePlanActive = computed(() => store.getters.getModalDeletePlanActive)
...
<template>
  ...
  <modal-box
    v-model="modalCreatePlanActive"
    large-title="CREATE PLAN"
    button="success"
    has-cancel
    button-label="Save"
    is-model-from-state="modalCreatePlanActiveToggle"
  ...
  <modal-box
    v-model="modalDeletePlanActive"
    large-title="DELETE ITEMS"
    button="success"
    has-cancel
    button-label="Save"
    is-model-from-state="modalDeletePlanActiveToggle"
